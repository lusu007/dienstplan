...
class SchoolHolidaysSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final holidaysState = ref.watch(schoolHolidaysNotifierProvider);
          ...
          cards: [
            NavigationCard(
              ...
              trailing: Switch(
                value: isEnabled,
                onChanged: (value) {
                  ref.read(schoolHolidaysNotifierProvider.notifier)
                      .toggleEnabled(value);
                },
              ),
              onTap: null,
            ...
            if (isEnabled) ...[
              NavigationCard(
                ...
                onTap: () async {
                  ...
                  if (selected != null) {
                    await ref.read(schoolHolidaysNotifierProvider.notifier)
