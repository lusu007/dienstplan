...
mixin _$SchoolHoliday {
  ...
  $SchoolHolidayCopyWith<SchoolHoliday> get copyWith =>
      _$SchoolHolidayCopyWithImpl<SchoolHoliday>(
        this as SchoolHoliday,
        _$identity,
      );
...
abstract mixin class $SchoolHolidayCopyWith<$Res> {
  factory $SchoolHolidayCopyWith(
    SchoolHoliday value,
    $Res Function(SchoolHoliday) _then,
  ) = _$SchoolHolidayCopyWithImpl;
  @useResult
  $Res call({
    String id,
    String name,
...
extension SchoolHolidayPatterns on SchoolHoliday {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SchoolHoliday value)? $default, {
...
class _SchoolHoliday extends SchoolHoliday {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SchoolHolidayCopyWith<_SchoolHoliday> get copyWith =>
      __$SchoolHolidayCopyWithImpl<_SchoolHoliday>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SchoolHoliday &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.startDate, startDate) ||
                other.startDate == startDate) &&
...
/// @nodoc
abstract mixin class _$SchoolHolidayCopyWith<$Res>
    implements $SchoolHolidayCopyWith<$Res> {
  factory _$SchoolHolidayCopyWith(
    _SchoolHoliday value,
    $Res Function(_SchoolHoliday) _then,
  ) = __$SchoolHolidayCopyWithImpl;
  @override
  @useResult
  $Res call({
    String id,
